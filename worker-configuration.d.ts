/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4d12ec79ee796975b2fb20f599c41cb)
// Runtime types generated with workerd@1.20260317.1 2026-03-18 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface PrdEnv {
		ASSETS: Fetcher;
		CLOUDFLARE_API_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		BASIC_AUTH_USER_ACC: string;
		BASIC_AUTH_PASSWORD_ACC: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "BASIC_AUTH_USER_ACC" | "BASIC_AUTH_PASSWORD_ACC" | "BASIC_AUTH_USER" | "BASIC_AUTH_PASSWORD" | "BASIC_AUTH_ENABLED">> {}
}
